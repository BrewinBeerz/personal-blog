    ...
    return (
      <div>
        ...
        <CardDeck>
          <Card>
            <Link to="/Arches">
              <Card.Img variant="top" src="/arches_card.jpg" />
            </Link>
            <Card.Body>
              <Link to="/Arches">
              ...
              <Card.Text>
                Photos taken during our trip to Arches National Park in
                September 2019.
              </Card.Text>
            </Card.Body>
          </Card>
          <Card>
            ...
            <Card.Body>
              ...
              <Card.Text>
                Photos taken during our trip to Canyonlands National Park in
                September 2019.
              </Card.Text>
            </Card.Body>
          </Card>
          <Card>
            ...
            <Card.Body>
              ...
              <Card.Text>
                Photos taken during our camping trip to Grand Canyon National
                Park in August 2019.
              </Card.Text>
            </Card.Body>
          </Card>
